...
export const checkout = asyncHandler(async (req, res) => {
  ...
  // if the cart is valid and there are products inside the cart: send those information to stripe and generate the payment link.
  const customer = {
    name: req.user.name,
...
export const instantCheckout = asyncHandler(async (req, res) => {
